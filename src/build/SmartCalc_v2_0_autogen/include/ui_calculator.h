...
"	background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 255), stop:1 rgb(255, 144, 0));\n"
"	border: 1px solid grey;\n"
"	border-radius: 5px;\n"
"	margin-bottom: 5px;\n"
"	margin-top: 5px;\n"
...
"\n"
"QPushButton:pressed  {\n"
"	background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgb(255, 144, 0), stop:1 rgba(0, 0, 0, 255));\n"
"}"));
